	...
	<form action="delete.jsp" method="post" target="_self">
		<table border="0" align="left" width=70% style="margin-left:10%">
			<tr>
				...
				<td width="100"><input type="submit" value="刪除" style="height:40px ; width:80px ; font-size:16px">
				<td width="200"><h5><font color="red">只能刪除未付款的訂單</font></h5>
